...
import { BookmarkIcon, ListIcon, ReplayIcon } from '@/components/icons/Icons';
 ...
 * saved-word count (links to /vocab filtered to this video), the per-video
 * glossary sheet (every word, coloured by knowledge), and replay.
 */
export function ActionRail({ video, onReplay, onOpenGlossary }: ActionRailProps) {
